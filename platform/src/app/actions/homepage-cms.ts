...
export async function getStats() {
  try {
    ...
    return [
      { id: '1', value: 50, suffix: '+', label: 'Projects Delivered', color: '#3B82F6', order: 1, isActive: true },
      { id: '2', value: 30, suffix: '+', label: 'Happy Clients', color: '#8B5CF6', order: 2, isActive: true },
      { id: '3', value: 99, suffix: '%', label: 'Satisfaction Rate', color: '#10B981', order: 3, isActive: true },
    ];
  }
}
...
export async function getTestimonials() {
  try {
    ...
    return [
        { id: '1', name: 'Sarah Mitchell', role: 'CTO', quote: 'The AI-driven dashboards transformed how we analyze market data.', rating: 5, avatar: 'SM', color: '#3B82F6', order: 1, isActive: true },
    ];
  }
}
...
export async function getSkills() {
  try {
    ...
    return [
      { id: '1', label: 'Web Development', value: 92, color: '#06B6D4', order: 3, isActive: true },
    ];
  }
}
...
export async function getTimelineEvents() {
  try {
    ...
    return [
      { id: '1', icon: '🚀', text: 'AI sales chatbot deployed — 3× lead conversion rate', timeAgo: '2d ago', color: '#3B82F6', order: 1, isActive: true },
    ];
  }
}
